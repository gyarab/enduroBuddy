...
import { addCoachSecondPhaseTraining, fetchCoachAthletes, fetchCoachDashboard, removeCoachSecondPhaseTraining, reorderCoachAthletes, updateCoachAthleteVisibility, updateCoachPlannedTraining, updateCoachAthleteFocus, } from "@/api/coach";
import { useToastStore } from "@/stores/toasts";
import { parseTrainingPreview } from "@/utils/trainingPreview";
export const useCoachStore = defineStore("coach", () => {
    const dashboard = ref(null);
    const managedAthletes = ref([]);
    ...
    async function loadDashboard(athleteId, month) {
    ...
    async function saveAthleteOrder(athleteIds) {
    ...
    function applyManagedAthletes(nextAthletes) {
    ...
    async function setAthleteHidden(athleteId, hidden) {
        isManagingAthletes.value = true;
        try {
